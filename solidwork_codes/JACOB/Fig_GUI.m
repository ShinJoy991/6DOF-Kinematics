...
% Last Modified by GUIDE v2.5 25-Nov-2023 13:02:36
...
%        get(hObject,'Min') and get(hObject,'Max') to determine range of slider
    ...
    t1=get(handles.slider7,'value');
    set(handles.edit14,'string',num2str(round(t1)));
...
%        get(hObject,'Min') and get(hObject,'Max') to determine range of slider
    ...
    t2=get(handles.slider8,'value');
    set(handles.edit15,'string',num2str(round(t2)));
...
%        get(hObject,'Min') and get(hObject,'Max') to determine range of slider
    ...
    t3=get(handles.slider9,'value');
    set(handles.edit16,'string',num2str(round(t3)));
...
%        get(hObject,'Min') and get(hObject,'Max') to determine range of slider
    ...
    t4=get(handles.slider10,'value');
    set(handles.edit17,'string',num2str(round(t4)));
...
%        get(hObject,'Min') and get(hObject,'Max') to determine range of slider
    ...
    t5=get(handles.slider11,'value');
    set(handles.edit18,'string',num2str(round(t5)));
...
%        get(hObject,'Min') and get(hObject,'Max') to determine range of slider
    ...
    t6=get(handles.slider12,'value');
    set(handles.edit19,'string',num2str(round(t6)));
...
ModelName = 'asem';
    ...
    v5=0;
    v6=0;
    set(handles.edit14,'string',num2str(v1));
    set(handles.edit15,'string',num2str(v2));
    set(handles.edit16,'string',num2str(v3));
    set(handles.edit17,'string',num2str(v4));
    set(handles.edit18,'string',num2str(v5));
    set(handles.edit19,'string',num2str(v6));
...
%[abra, cadabra] = subfuntest(1, 2)
    [T01, T02, T03, T04, T05, T06] = fk_ve(teta1, teta2, teta3, teta4, teta5, teta6);

    Px1=T06(1,4);
    Py1=T06(2,4);
    Pz1=T06(3,4);

    Jacob_Rot_Col1 = [T01(1,3);T01(2,3);T01(3,3)];
    Jacob_Rot_Col2 = [T02(1,3);T02(2,3);T02(3,3)];
    Jacob_Rot_Col3 = [T03(1,3);T03(2,3);T03(3,3)];
    Jacob_Rot_Col4 = [T04(1,3);T04(2,3);T04(3,3)];
    Jacob_Rot_Col5 = [T05(1,3);T05(2,3);T05(3,3)];
    Jacob_Rot_Col6 = [T06(1,3);T06(2,3);T06(3,3)];

    Jacob_Pos = jacobian([Px1,Py1,Pz1], [teta1;teta2;teta3;teta4;teta5;teta6]);

    Jacob = [Jacob_Pos;Jacob_Rot_Col1 Jacob_Rot_Col2 Jacob_Rot_Col3 Jacob_Rot_Col4 Jacob_Rot_Col5 Jacob_Rot_Col6];

    Sub_Jacob = subs(Jacob,{teta1,teta2,teta3,teta4,teta5,teta6},{t1,t2+90,t3,t4+180,t5,t6});

    Omega_velocity = [v1;v2;v3;v4;v5;v6];
    Foward_velocity = Sub_Jacob*Omega_velocity;

    omega1=double(Foward_velocity(1,1));
    omega2=double(Foward_velocity(2,1));
    omega3=double(Foward_velocity(3,1));
    omega4=double(Foward_velocity(4,1));
    omega5=double(Foward_velocity(5,1));
    omega6=double(Foward_velocity(6,1));

    set(handles.edit7,'string',num2str(omega1));
    set(handles.edit8,'string',num2str(omega2));
    set(handles.edit9,'string',num2str(omega3));
    set(handles.edit11,'string',num2str(omega4));
    set(handles.edit12,'string',num2str(omega5));
    set(handles.edit13,'string',num2str(omega6));
